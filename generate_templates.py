...
templates_map = {
    ...
    "templates": [
...

        {
            ...
            "group": "procuracy",
            "description": "Если в течении 30 дней вы не получали уведомлений о продлении срока рассмотрения или ответ на так и не был получен, это нарушение закона. Согласно ФЗ \"О порядке рассмотрения обращений граждан Российской Федерации\", обращение рассматривается в течение 30 дней со дня регистрации.",
