...
templates_map = {
    ...
    "templates": [
...

        {
            ...
            "group": "procuracy",
            "description": "Если в течении 30 дней вы не получили, уведомлений о продлении срока рассмотрения или ответа на так и не поступило, то являеются наршением закона. Согласно ФЗ \"О порядке рассмотрения обращений граждан Российской Федерации\", обращение рассматривается в течение 30 дней со дня регистрации.",
