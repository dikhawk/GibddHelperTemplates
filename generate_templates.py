...
templates_map = {
    ...
    "templates": [
        ...
        },
        {
            "id": "sidewalk_driving",
            "group": "roads",
            "description": "По данному обращению вас могу вызвать в ГИБДД в качестве свидетеля. Для большей эффективности рекомендуется использовать видео. Либо сделать несколько фото, на котором видно движение автомобиля",
